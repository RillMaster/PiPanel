...
class SettingsManager(context: Context) {
    ...
    var cpuAlertsEnabled: Boolean
        ...
        set(value) = prefs.edit().putBoolean("cpu_alerts_enabled", value).apply()
    ...
    var ramAlertsEnabled: Boolean
        ...
        set(value) = prefs.edit().putBoolean("ram_alerts_enabled", value).apply()
    ...
    var watchdogIntervalSeconds: Int
        ...
        set(value) = prefs.edit().putInt("watchdog_interval", value).apply()
    ...
    var dockerAlertsEnabled: Boolean
        ...
        set(value) = prefs.edit().putBoolean("docker_alerts_enabled", value).apply()
}